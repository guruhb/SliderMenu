...
public class SettingsUpdateFrequency {
    ...
    private void updateTitle(Dialog dlg, int freq) {
        dlg.setTitle(String.valueOf(freq + mSeekBarOffset));
    }
    private int getUpdateFrequency() {
        ...
        return myPref.getInt(mContext.getString(R.string.key_location_update), mSeekBarOffset);
    }
